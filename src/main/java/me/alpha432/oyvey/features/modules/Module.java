...
public class Module extends Feature implements Jsonable {
    ...
    public void enable() {
        ...
        if (OyVey.moduleManager.getModuleByClass(Notifications.class).isEnabled()) {
            Command.sendMessage1(ChatUtil.getClient()  + OyVey.commandManager.getClientMessage()+ " " + Formatting.WHITE + this.getDisplayName() + Formatting.GREEN + " on");
        }
    ...
    public void disable() {
        ...
        if (OyVey.moduleManager.getModuleByClass(Notifications.class).isEnabled()) {
            Command.sendMessage1(ChatUtil.getClient() + OyVey.commandManager.getClientMessage() + " " + Formatting.WHITE + this.getDisplayName()  + Formatting.RED + " off");
        }
        this.onToggle();
        this.onDisable();
    }
